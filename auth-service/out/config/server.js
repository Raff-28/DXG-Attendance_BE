...
import { JwtImpl } from "../pkg/jwt/jwt.js";
...
export async function startServer() {
    ...
    const authController = new AuthController(new AuthUseCaseImpl(new AuthRepositoryImpl(db), new TransactionManagerImpl(db), new BcryptImpl(), new JwtImpl()));
