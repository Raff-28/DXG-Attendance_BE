...
export async function startServer() {
    ...
    const r = setupRouter(new EmployeeController(new EmployeeUsecaseImpl(new EmployeeRepositoryImpl(db), new UserRepositoryImpl(db), new AttendanceRepositoryImpl(db), new TransactionManagerImpl(db))));
